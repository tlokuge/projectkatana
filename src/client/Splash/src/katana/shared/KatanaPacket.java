...
public class KatanaPacket
{
    ...
    {
        String packet = String.format(KatanaConstants.PACKET_FORMATTER, packet_id, opcode.ordinal(), data);
    ...
    {
        return String.format(KatanaConstants.PACKET_FORMATTER, packet_id, opcode.ordinal(), data);
    }
