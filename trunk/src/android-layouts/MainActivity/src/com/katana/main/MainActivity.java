...
public class MainActivity extends Activity {
	...
	@Override public void onBackPressed() {
		...
		if (inRoom == true) {
			inRoom = false;
			vf.setInAnimation(MainActivity.this, R.anim.transition_infrom_right);
    		vf.setOutAnimation(MainActivity.this, R.anim.transition_outfrom_right);
    		vf.showPrevious();
		} else {
			this.finish();
		}
    ...
    public void joinRoom(){
    	...
    	if(newRoom) {
    		...
    		vf.setInAnimation(MainActivity.this, R.anim.transition_infrom_left);
    		vf.setOutAnimation(MainActivity.this, R.anim.transition_outfrom_left);
    		vf.showNext();
    	} else if (!newRoom) {
    		message = "Join Room!";
    		inRoom = true;
    ...
    public void makeRoom(){
    	RadioGroup diffSel = (RadioGroup)MainActivity.this.createRoomDialog.findViewById(R.id.rg_roomdiff);
    	RadioGroup plyrSel = (RadioGroup)MainActivity.this.createRoomDialog.findViewById(R.id.rg_roommaxplr);
    	EditText rmName = (EditText)MainActivity.this.createRoomDialog.findViewById(R.id.l_roomname);
